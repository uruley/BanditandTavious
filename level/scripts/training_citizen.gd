...
@export var body_color: Color = Color(0.85, 0.7, 0.1, 1.0)
...
var time_near_threat: float = 0.0
...
func get_fitness_score() -> float:
	return survival_time * 1.5 + pickups_collected * 20.0 - time_near_threat * 0.5
...
func get_ai_snapshot() -> Dictionary:
	return {"name": name, "role": "citizen", "position": global_position,
		"survival_time": survival_time, "pickups": pickups_collected}
